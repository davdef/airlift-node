...
# Kompiliere und führe minimalen Test aus
echo "Kompiliere minimalen Test..."
rustc --extern airlift_node=target/debug/deps/libairlift_node.rlib \
      --edition=2021 test_minimal.rs -o test_minimal && ./test_minimal
